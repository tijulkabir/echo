<p align="center">
    <img src="https://github.com/user-attachments/assets/188c42f8-d249-4a72-b27a-e2b4f10a00a8" alt="Echo Android Logo" width="480">
</p>
...
A secure, decentralized, peer-to-peer messaging app that works over Bluetooth mesh networks. No internet required for mesh chats, no servers, no phone numbers - just pure encrypted communication. Echo also supports geohash channels, which use an internet connection to connect you with others in your geographic area.

This is the **Android port** of the original [Echo iOS app](https://github.com/jackjackbits/Echo), maintaining 100% protocol compatibility for cross-platform communication.

## Install Echo

You can download the latest version of Echo for Android from the [GitHub Releases page](https://github.com/tijulkabir/echo/releases).

Or you can:

[<img alt="Get it on Google Play" height="60" src="https://play.google.com/intl/en_us/badges/static/images/badges/en_badge_web_generic.png"/>](https://play.google.com/store/apps/details?id=com.Echo.droid)
...
- **✅ Cross-Platform Compatible**: Full protocol compatibility with iOS Echo
...
2. **Open in Android Studio:**
   ...
   # Navigate to the Echo-android directory
   ```
...
3. **Launch Echo** - it will auto-start mesh networking
4. **Set your nickname** or use the auto-generated one
5. **Connect automatically** to nearby iOS and Android Echo users
...
### Binary Protocol
Echo uses an efficient binary protocol optimized for Bluetooth LE:
...
1. **EchoApplication.kt**: Application-level initialization and dependency injection
...
This Android port enables seamless communication with the original iOS Echo app:
...
**iOS Version**: For iPhone/iPad users, get the original Echo at [github.com/jackjackbits/Echo](https://github.com/jackjackbits/Echo)
...
- **iOS Compatibility**: Cross-reference with [original iOS repo](https://github.com/jackjackbits/Echo)

For iOS-specific issues, please refer to the [original iOS Echo repository](https://github.com/jackjackbits/Echo).
