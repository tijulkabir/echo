...
-keep class com.echo.android.protocol.** { *; }
-keep class com.echo.android.crypto.** { *; }
-dontwarn org.bouncycastle.**
-keep class org.bouncycastle.** { *; }

# Keep SecureIdentityStateManager from being obfuscated to prevent reflection issues
-keep class com.echo.android.identity.SecureIdentityStateManager {
    private android.content.SharedPreferences prefs;
    *;
}

# Keep all classes that might use reflection
-keep class com.echo.android.favorites.** { *; }
-keep class com.echo.android.nostr.** { *; }
-keep class com.echo.android.identity.** { *; }

# Keep Tor implementation (always included)
-keep class com.echo.android.net.RealTorProvider { *; }
