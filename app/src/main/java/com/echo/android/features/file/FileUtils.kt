package com.echo.android.features.file
...
object FileUtils {
    ...
    fun saveIncomingFile(
        context: Context,
        file: com.echo.android.model.BitchatFilePacket
    ): String {
     ...
     */
    fun messageTypeForMime(mime: String): com.echo.android.model.BitchatMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> com.echo.android.model.BitchatMessageType.Image
            lower.startsWith("audio/") -> com.echo.android.model.BitchatMessageType.Audio
            else -> com.echo.android.model.BitchatMessageType.File
        }
    }
