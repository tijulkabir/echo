package com.echo.android.noise

import android.content.Context
import android.util.Log
import com.echo.android.identity.SecureIdentityStateManager
import com.echo.android.mesh.PeerFingerprintManager
import com.echo.android.noise.southernstorm.protocol.Noise
...
class NoiseEncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val REKEY_TIME_LIMIT = com.echo.android.util.AppConstants.Noise.REKEY_TIME_LIMIT_MS // 1 hour (same as iOS)
        private const val REKEY_MESSAGE_LIMIT = com.echo.android.util.AppConstants.Noise.REKEY_MESSAGE_LIMIT_ENCRYPTION // 1k messages (matches iOS) (same as iOS)
    }
    ...
    private fun generateKeyPair(): Pair<ByteArray, ByteArray> {
        try {
            val dhState = com.echo.android.noise.southernstorm.protocol.Noise.createDH("25519")
     ...
     */
    fun signPacket(packet: com.echo.android.protocol.BitchatPacket): com.echo.android.protocol.BitchatPacket? {
     ...
     */
    fun verifyPacketSignature(packet: com.echo.android.protocol.BitchatPacket, publicKey: ByteArray): Boolean {
