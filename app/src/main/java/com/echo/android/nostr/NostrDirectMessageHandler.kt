package com.echo.android.nostr

import android.app.Application
import android.util.Log
import com.echo.android.model.BitchatFilePacket
...
import com.echo.android.model.PrivateMessagePacket
import com.echo.android.protocol.BitchatPacket
import com.echo.android.services.SeenMessageStore
import com.echo.android.ui.ChatState
import com.echo.android.ui.MeshDelegateHandler
import com.echo.android.ui.PrivateChatManager
...
class NostrDirectMessageHandler(
    ...
    private val dataManager: com.echo.android.ui.DataManager
) {
    ...
    fun onGiftWrap(giftWrap: NostrEvent, geohash: String, identity: NostrIdentity) {
        scope.launch(Dispatchers.Default) {
            try {
                ...
                if (packet.type != com.echo.android.protocol.MessageType.NOISE_ENCRYPTED.value) return@launch
                ...
                com.echo.android.nostr.GeohashAliasRegistry.put(convKey, senderPubkey)
        ...
        when (payload.type) {
            ...
            NoisePayloadType.FILE_TRANSFER -> {
                ...
                if (file != null) {
                    ...
                    val savedPath = com.echo.android.features.file.FileUtils.saveIncomingFile(application, file)
                    val message = BitchatMessage(
                        id = uniqueMsgId,
                        sender = senderNickname,
                        content = savedPath,
