package com.echo.android.protocol
...
object CompressionUtil {
    private const val COMPRESSION_THRESHOLD = com.echo.android.util.AppConstants.Protocol.COMPRESSION_THRESHOLD_BYTES  // bytes - same as iOS
