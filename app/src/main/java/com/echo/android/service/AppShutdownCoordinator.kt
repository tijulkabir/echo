...
object AppShutdownCoordinator {
    ...
    fun requestFullShutdownAndKill(
        ...
        val job = scope.launch {
            ...
            try {
                val intent = android.content.Intent(com.echo.android.util.AppConstants.UI.ACTION_FORCE_FINISH)
                    .setPackage(app.packageName)
                app.sendBroadcast(intent, com.echo.android.util.AppConstants.UI.PERMISSION_FORCE_FINISH)
            } catch (_: Exception) { }
