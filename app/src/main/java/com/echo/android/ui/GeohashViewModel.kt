...
import com.echo.android.nostr.GeohashMessageHandler
import com.echo.android.nostr.GeohashRepository
import com.echo.android.nostr.NostrDirectMessageHandler
import com.echo.android.nostr.NostrIdentityBridge
import com.echo.android.nostr.NostrProtocol
import com.echo.android.nostr.NostrRelayManager
import com.echo.android.nostr.NostrSubscriptionManager
import com.echo.android.nostr.PoWPreferenceManager
import com.echo.android.nostr.GeohashAliasRegistry
import com.echo.android.nostr.GeohashConversationRegistry
...
class GeohashViewModel(
    ...
    private var locationChannelManager: com.echo.android.geohash.LocationChannelManager? = null
    ...
    fun initialize() {
        ...
        try {
            locationChannelManager = com.echo.android.geohash.LocationChannelManager.getInstance(getApplication())
            ...
            state.setSelectedLocationChannel(com.echo.android.geohash.ChannelID.Mesh)
    ...
    fun sendGeohashMessage(content: String, channel: com.echo.android.geohash.GeohashChannel, myPeerID: String, nickname: String?) {
        viewModelScope.launch {
            try {
                ...
                val localMsg = com.echo.android.model.BitchatMessage(
                    id = tempId,
                ...
                if (startedMining) {
                    com.echo.android.ui.PoWMiningTracker.startMiningMessage(tempId)
                }
                try {
                    ...
                    if (startedMining) {
                        com.echo.android.ui.PoWMiningTracker.stopMiningMessage(tempId)
                    }
                }
            } catch (e: Exception) {
    ...
    fun startGeohashDM(pubkeyHex: String, onStartPrivateChat: (String) -> Unit) {
        ...
        val gh = (current as? com.echo.android.geohash.ChannelID.Location)?.channel?.geohash
        if (!gh.isNullOrEmpty()) {
    ...
    fun blockUserInGeohash(targetNickname: String) {
        ...
        if (pubkey != null) {
            ...
            val sysMsg = com.echo.android.model.BitchatMessage(
                sender = "system",
    ...
    private fun switchLocationChannel(channel: com.echo.android.geohash.ChannelID?) {
        ...
        when (channel) {
            is com.echo.android.geohash.ChannelID.Mesh -> {
            ...
            is com.echo.android.geohash.ChannelID.Location -> {
